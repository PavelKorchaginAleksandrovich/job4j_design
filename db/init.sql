...
insert into categories (name) values ('service'), ('support'), ('other');

insert into states(name) values ('new'), ('in progress'), ('done');
...
insert into attachs(name, item_id) values ('photo', 2);
insert into attachs(name, item_id) values ('order', 3);
insert into attachs(name, item_id) values ('invoice', 3);
